...
// Import type from the Vue component using alias
import type { RankingItem } from '@/components/charts/TopRankingCard.vue'
...
// 根据仪表盘需要组合数据
// 注意：确保这里的 key 与 AssetMonitoring.vue 中访问 dashboardRankingData 的 key 一致
export const dashboardRankingData = {
  applicationInteraction: applicationInteractionRankData,
  riskyBusinessApp: riskBusinessRankData, // Use the key expected by AssetMonitoring.vue
  frequentLoginUser: frequentLoginUserRankData,
  riskyDataUser: riskUserRankData, // Use the key expected by AssetMonitoring.vue
  // Add other rankings if needed by other components/pages
